...
type SubmitHandler = (data: ReviewFormData) => void;

export function renderReviewForm(existing?: Review): string {
      ...
      <div style="margin-bottom:var(--space-4);">
        ...
        <div class="stars" id="star-input">
          ${Array.from({ length: 5 }, (_, i) =>
            `<span class="star${i < rating ? ' filled' : ''}" data-value="${i + 1}" role="button" tabindex="0">★</span>`
          ).join('')}
        </div>
...
export function attachReviewFormEvents(
